...
struct GradientBackgroundView: View {
    let yellowColor = Color(red: 0.99607844, green: 0.9764705882, blue: 0.9529411765)
    let redColor = Color(red: 0.9921568627, green: 0.9490196078, blue: 0.97254901196)
    let blueColor = Color(red: 0.9333333333, green: 0.968627451, blue: 0.9960784314)
